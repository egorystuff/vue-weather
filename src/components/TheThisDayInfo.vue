...
<template>
  <div
    class="bg-component relative border border-component shadow-lg rounded-xl min-h-72 p-4 w-2/3 p-2 ml-2"
  >
    <div class="flex justify-between items-center p-2"></div>
    <img class="absolute right-0 top-0 w-1/2" src="../assets/images/cloud.png" alt="cloud" />
